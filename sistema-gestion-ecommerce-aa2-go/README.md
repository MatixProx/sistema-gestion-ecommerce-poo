...
## Documentos incluidos para la entrega

- `docs/informe-aa2-desarrollo-sistema-ecommerce.docx`: informe formal del avance.
- `docs/informe-aa2-desarrollo-sistema-ecommerce.pdf`: version PDF del informe formal.
- `docs/cumplimiento-rubrica.md`: explicacion directa de como se cumple cada criterio de la rubrica.
- `docs/evidencia-ejecucion.txt`: salida de pruebas, revision con go vet y demostracion del sistema.
- `docs/guion-video-avance.md`: guion para grabar el video explicativo.
- `docs/guion-video-demostracion.md`: guion para grabar el video de funcionalidades.
- `docs/texto-entrega-canvas.txt`: texto listo para pegar en Canvas con el repositorio y espacios para enlaces de videos.
